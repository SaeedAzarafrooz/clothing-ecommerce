...
function CartIcon() {
  ...
  return (
    <div onClick={toggleIsCartOpen} className='group relative w-11 h-11 flex justify-center items-center  cursor-pointer hover:bg-slate-300 rounded-md transition-all duration-300 ease-in-out'>
